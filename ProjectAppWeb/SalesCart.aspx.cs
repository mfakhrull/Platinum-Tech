...
namespace ProjectAppWeb
{
    public partial class SalesCart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (hiddenCardVisible.Value == "true")
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "displayCard", "document.getElementById('summaryCard').style.display = 'block';", true);
                }
            }
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            SalesConfirm();
            DisplayInvoice();
            // Call SweetAlert2 to show a success message
            ScriptManager.RegisterStartupScript(this, GetType(), "showAlert", "Swal.fire('Success!', 'Successfully confirmed sales.', 'success');", true);
            hiddenCardVisible.Value = "true";
        }

        protected void btnNew_Click(object sender, EventArgs e)
        {
            ClearAll();
            Response.Redirect("ShopItem.aspx"); // Redirect to ShopItem page
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            ClearAll();
            Response.Redirect("ShopItem.aspx"); // Redirect to ShopItem page
            ScriptManager.RegisterStartupScript(this, GetType(), "showAlert", "Swal.fire('Success!', 'Successfully cancel sale.', 'success');", true);
