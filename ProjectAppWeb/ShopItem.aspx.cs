    ...
    public partial class ShopItem : System.Web.UI.Page
    {
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            if (lblItemTitle.Text == "")
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "showAlert", "Swal.fire('Warning!', 'You have to select an item first.', 'warning');", true);
            }
            else
            {
                SalesAddItem();
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "showAlert", "Swal.fire('Success!', 'Successfully added item to cart', 'success');", true);
                ClearAll();
            }
        }
